...
class UpdateAboutPageRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'homepage_about_label' => ['required', 'string', 'max:120'],
            'homepage_about_title' => ['required', 'string', 'max:220'],
            'homepage_about_description' => ['required', 'string', 'max:1000'],
            'homepage_checklist_1' => ['required', 'string', 'max:120'],
            'homepage_checklist_2' => ['required', 'string', 'max:120'],
            'homepage_checklist_3' => ['required', 'string', 'max:120'],
            'homepage_checklist_4' => ['required', 'string', 'max:120'],
            'homepage_cta_small_text' => ['required', 'string', 'max:160'],
            'homepage_cta_main_text' => ['required', 'string', 'max:160'],
            'homepage_cta_url' => ['required', 'string', 'max:255'],
            'homepage_button_label' => ['required', 'string', 'max:120'],
            'homepage_button_url' => ['required', 'string', 'max:255'],
            'homepage_about_image' => ['nullable', 'image', 'mimes:jpeg,png,jpg,webp', 'max:3072'],
