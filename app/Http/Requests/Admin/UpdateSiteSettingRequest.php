...
class UpdateSiteSettingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'home_consultation_eyebrow' => ['nullable', 'string', 'max:80'],
            'home_consultation_title' => ['nullable', 'string', 'max:180'],
            'home_consultation_feature_one' => ['nullable', 'string', 'max:120'],
            'home_consultation_feature_two' => ['nullable', 'string', 'max:120'],
            'home_consultation_description' => ['nullable', 'string', 'max:700'],
            'home_consultation_contact_label' => ['nullable', 'string', 'max:120'],
            'home_consultation_card_title' => ['nullable', 'string', 'max:120'],
            'home_consultation_card_description' => ['nullable', 'string', 'max:400'],
            'home_consultation_button_text' => ['nullable', 'string', 'max:120'],
