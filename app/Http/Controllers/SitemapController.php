...
class SitemapController extends Controller
{
    public function __invoke(): Response
    {
        $urls = collect([
            ...
            ['loc' => route('landing-page-development'), 'changefreq' => 'weekly', 'priority' => '0.9'],
            ['loc' => route('application-development'), 'changefreq' => 'weekly', 'priority' => '0.9'],
            ['loc' => route('website-development'), 'changefreq' => 'weekly', 'priority' => '0.95'],
            ['loc' => route('website-development-company-profile'), 'changefreq' => 'weekly', 'priority' => '0.9'],
            ...
            ['loc' => route('website-development-pandeglang'), 'changefreq' => 'weekly', 'priority' => '0.85'],
            ['loc' => route('website-development-serang-murah'), 'changefreq' => 'weekly', 'priority' => '0.85'],
            ['loc' => route('website-development-umkm-serang'), 'changefreq' => 'weekly', 'priority' => '0.85'],
            ['loc' => route('seo-serang'), 'changefreq' => 'weekly', 'priority' => '0.9'],
