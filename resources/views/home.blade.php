...
@push('head')
    ...
    @endif
    <link rel="preload" as="style" href="https://fonts.googleapis.com/css2?family=Nunito:wght@400;600;700;800&family=Rubik:wght@400;500;600;700&display=optional" media="(min-width: 768px)">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Nunito:wght@400;600;700;800&family=Rubik:wght@400;500;600;700&display=optional" media="(min-width: 768px)">
    <noscript><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Nunito:wght@400;600;700;800&family=Rubik:wght@400;500;600;700&display=optional"></noscript>
    <style>
        .startup2-home {
        ...
        @media (min-width: 768px) and (max-width: 991.98px) {
            .startup2-home .homepage-services-grid > .col-md-6 {
                width: 50%;
            }
        }
    </style>
...
@section('content')
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            ...
            <div class="row g-5 homepage-services-grid">
                @foreach ([
                    ...
                    ['title' => 'Web Application', 'body' => 'Aplikasi web custom untuk workflow, data, dan proses operasional bisnis.', 'icon' => '03', 'url' => route('application-development'), 'label' => 'Lihat layanan Web Application'],
                    ...
                    ['title' => 'AI Integration', 'body' => 'Integrasi AI dan automation yang relevan untuk mempercepat pekerjaan tim.', 'icon' => '06', 'url' => route('contact'), 'label' => 'Lihat layanan AI Integration'],
                ] as $service)
