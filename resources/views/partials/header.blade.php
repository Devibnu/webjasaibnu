...
@if (request()->routeIs('home') || request()->routeIs('services.index') || request()->routeIs('application-development') || request()->routeIs('seo-serang') || request()->routeIs('website-development*') || request()->routeIs('solutions.index') || request()->routeIs('portfolio.index') || request()->routeIs('insights.*') || request()->routeIs('about') || request()->routeIs('contact'))
